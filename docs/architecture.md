...
| `protocol/ut80x/` | UT803/UT804: `Ut80xProtocol` — streaming over the CH9325 cable, one payload parser per model; `specs_ut803.rs`/`specs_ut804.rs` hold the spec tables |
